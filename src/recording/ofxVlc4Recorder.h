...
// ofxVlc4RecorderPerformanceInfo is defined in core/ofxVlc4Types.h.
...
private:
	...
	bool setVideoCaptureKeyframeInterval(int keyframeInterval, std::string & errorOut);
	int getVideoCaptureKeyframeInterval() const;
